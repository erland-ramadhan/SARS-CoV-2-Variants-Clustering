...
km = KModes(n_clusters=clust_num, init='Huang', n_init=5, verbose=0)
km_clust_labels = km.fit_predict(X)

np.save(os.getcwd() + '/new_Labels_kmodes_org.npy', km_clust_labels)
